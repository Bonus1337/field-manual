...
title: "Footprinting & Scanning - aktywne rozpoznanie, Nmap i interpretacja wyników"
team: red
domain: certifications
section: ejpt
topic: footprinting-scanning
type: knowledge
angle: active-recon-scanning-workflow
sourceTrack: ejpt-preparation
tags: ["nmap", "scanning", "host-discovery", "port-scan", "fingerprinting", "evasion"]
difficulty: easy
shortDescription: "Kompleksowy materiał o footprintingu i skanowaniu w kontekście przygotowania do eJPT, porządkujący aktywne rozpoznanie od host discovery, przez port scanning, fingerprinting usług i systemów, po skrypty NSE, techniki evasion, zapis wyników oraz interpretację skanów jako podstawę do dalszej enumeracji."
