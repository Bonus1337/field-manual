...
title: "Enumeration - Field Manual dla eJPT, workflow usług i łączenie tropów"
team: red
domain: certifications
section: ejpt
topic: enumeration
type: knowledge
angle: pentest-enumeration-workflow
sourceTrack: ejpt-preparation
tags: ["enumeration", "recon", "active-recon", "nmap", "enum4linux", "smbclient", "ejpt"]
difficulty: easy
shortDescription: "Praktyczny field manual do enumeration w kontekście przygotowania do eJPT, pokazujący jak przechodzić od skanu portów do konkretnych hipotez ataku - przez analizę usług, wersji, użytkowników, udziałów, katalogów, baz danych, poświadczeń i powiązań między FTP, SMB, HTTP, MySQL, SSH, SMTP oraz innymi usługami."
