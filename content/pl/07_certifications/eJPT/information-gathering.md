...
title: "Information Gathering - passive recon, active recon i budowanie mapy celu"
team: red
domain: certifications
section: ejpt
topic: information-gathering
type: knowledge
angle: recon-methodology-workflow
sourceTrack: ejpt-preparation
tags: ["recon", "passive", "active", "nmap", "dns", "osint", "whois", "subdomain", "ejpt"]
difficulty: easy
shortDescription: "Kompleksowy materiał o information gathering w kontekście przygotowania do eJPT, porządkujący cały proces rozpoznania celu - od scope, passive reconu, OSINT, WHOIS, DNS, subdomen, technologii i wycieków informacji, po active recon, skanowanie Nmapem, zone transfer, NSE oraz organizowanie wyników jako podstawy do dalszej enumeracji."
