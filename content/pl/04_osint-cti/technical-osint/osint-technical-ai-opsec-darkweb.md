...
title: "OSINT techniczny: recon, AI, OPSEC, canary tokens i wstęp do dark webu"
team: red-blue
domain: osint-cti
section: technical-osint
type: methodology
angle: technical-osint-ai-opsec-workflow
sourceTrack: osint-sekurak
tags: ["osint", "recon", "ai", "opsec", "darkweb", "shodan", "censys", "urlscan", "crtsh"]
difficulty: easy
shortDescription: "Przekrojowy workflow nowoczesnego OSINT-u technicznego: jak łączyć recon domen, subdomen, certyfikatów, usług i assetów z AI, oceną wiarygodności, OPSEC-em, canary tokenami, higieną dokumentów oraz bezpiecznym podejściem do zasobów dark webu."
