...
title: "PortSwigger Access Control - panel admina ukryty pod nieprzewidywalnym URL"
team: red
domain: labs-writeups
section: portswigger
topic: access-control
type: writeup
angle: hidden-admin-url-source-disclosure
sourceTrack: portswigger-web-security-academy
tags: ["portswigger", "access-control", "admin-panel", "source-code", "misconfiguration"]
difficulty: apprentice
shortDescription: "Write-up z labu PortSwigger pokazujący, że ukrycie panelu administracyjnego pod nieprzewidywalnym adresem nie zapewnia realnej kontroli dostępu, jeśli ścieżka wycieka w kodzie źródłowym, a serwer nadal nie egzekwuje autoryzacji dla funkcji uprzywilejowanych."
