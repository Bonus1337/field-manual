...
title: "PortSwigger Access Control - IDOR na statycznych transkryptach czatu"
team: red
domain: labs-writeups
section: portswigger
topic: access-control
type: writeup
angle: idor-static-file-access
sourceTrack: portswigger-web-security-academy
tags: ["idor", "information-disclosure", "static-files", "predictable-ids"]
difficulty: apprentice
shortDescription: "Krótki write-up z labu PortSwigger pokazujący IDOR na statycznych plikach z przewidywalnym identyfikatorem, gdzie brak autoryzacji przy pobieraniu transkryptów czatu pozwala odczytać cudzy plik, znaleźć hasło użytkownika i przejąć jego konto."
