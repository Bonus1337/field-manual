...
- **Proces > payloady.** Recon → enum → exploit → post → raport.
- **Mniej magii, więcej zrozumienia.** Jak coś działa, to wiem _dlaczego_.
- **Blue daje fundamenty Red.** Obrona tłumaczy atak szybciej niż memy o “hakowaniu”.

## Dla kogo jest ta strona

Dla ludzi, którzy:

- uczą się ofensywy/defensywy i chcą mieć jedno miejsce z notatkami
