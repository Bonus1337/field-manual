...
- **Process > payloads.** Recon → enum → exploit → post → report.
- **Less magic, more understanding.** If it works, I know _why_.
- **Blue builds Red foundations.** Defense often explains attacks faster than memes.

## Who this is for

People who:

- learn offense/defense and want one clean place for notes
